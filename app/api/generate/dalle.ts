...
Recreate the same creature, keeping the body structure, pose, key features intact, and same color palette.
...
Do not change the creature into a different one, and do not change its overall body orientation.
