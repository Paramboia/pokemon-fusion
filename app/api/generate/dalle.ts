...
const ENHANCEMENT_PROMPT = `Use the uploaded image as the exact new Digimon design reference for the output.
Recreate the same Digimon, keeping the body structure, pose, key features intact, and same color palette.
...
Do not change the Digimon into a different one, and do not change its overall body orientation.
